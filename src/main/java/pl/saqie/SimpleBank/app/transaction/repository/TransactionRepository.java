...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    @Query ("select new pl.saqie.SimpleBank.app.account.model.dto.ExpenseDto(t.description, t.value, t.createdDate, a.accountNumber, a.allExpenses) from Transaction t join t.accountTo a where t.accountFrom = :id order by t.createdDate")
    Page<ExpenseDto> customFindExpensesByDate(BankAccount id, Pageable pageable);

    @Query("select new pl.saqie.SimpleBank.app.account.model.dto.IncomeDto(t.description, t.value, t.createdDate, a.accountNumber, a.allIncomes) from Transaction t join t.accountFrom a where t.accountTo = :id order by t.createdDate")
